...
public class RedisService {
     ...
     * @param <T>
     */
    public <T> String geoGet(final String key, final Object member) {
        String gps = null;
        List<Point> points = redisTemplate.opsForGeo().position(key, member);
        if (points != null && points.size() > 0) {
            gps = points.get(0).getX() + "," + points.get(0).getY();
        }
        return gps;
    }
     ...
     * @return
     */
    public <T> GeoResults geoRadius(final String key, final Double longitude, final Double latitude, final Double radius) {
     ...
     * @param <T>
     */
    public <T> void geoAdd(final String key, final Double longitude, final Double latitude, final Object member) {
