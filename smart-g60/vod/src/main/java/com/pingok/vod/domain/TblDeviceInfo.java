...
//    private boolean flag = false;
    ...
    @Size(min = 0, max = 50, message = "设备类目长度不能超过50个字符")
    ...
    @Size(min = 0, max = 20, message = "设备名称长度不能超过20个字符")
    ...
    @Size(min = 0, max = 20, message = "设备品牌长度不能超过20个字符")
    ...
    @Size(min = 0, max = 50, message = "设备型号长度不能超过50个字符")
    ...
    @Size(min = 0, max = 50, message = "厂商长度不能超过50个字符")
    ...
    @Size(min = 0, max = 50, message = "管理方长度不能超过50个字符")
    public String getManagementSide()
    {
        return managementSide;
    }

    public void setManagementSide(String managementSide) { this.managementSide = managementSide; }

    @Size(min = 0, max = 50, message = "使用方长度不能超过50个字符")
    ...
    @Size(min = 0, max = 30, message = "起始路名长度不能超过30个字符")
...
//    public void setLaneBelong(String laneBelong) { this.laneBelong = laneBelong; }
    ...
    public Byte getMonitorLevel()
    {
        return monitorLevel;
    }

    public void setMonitorLevel(Byte monitorLevel) { this.monitorLevel = monitorLevel; }
