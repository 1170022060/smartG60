...
public class TblEventRecord {
    ...
    public void setLocationInterval(String locationInterval) {this.locationInterval = locationInterval;}
    ...
    public void setEventPhoto(String eventPhoto) {this.eventPhoto = eventPhoto;}
    ...
    public void setRelieveTime(Date relieveTime) { this.relieveTime = relieveTime; }
    ...
    public void setRelieveUserId(Long relieveUserId) { this.relieveUserId = relieveUserId; }
