...
public interface TblOptWorkInfoMapper extends CommonRepository<TblOptWorkInfo> {
    ...
    @Select({"<script>" +
            ...
            "left join  SYS_USER b on a.OPT_ID=b.USER_ID " +
            ...
            "</script>"})
    List<Map> selectOptWorkInfo( @Param("startDate") Date startDate,@Param("endDate") Date endDate,@Param("stationId") String stationId, @Param("optName") String optName,@Param("shift") Integer shift);
