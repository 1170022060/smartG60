...
public class ProvincialCentersController extends BaseController {
    ...
    @PostMapping
    public R getData(@RequestParam(value = "name") String name, @RequestParam(value = "dateTimeNow") Date dateTimeNow) {
        JSONArray jsonArray = iProvincialCentersService.getData(name, dateTimeNow);
