...
import com.pingok.gantry.service.gantry110.IGantry1120Service;
...
@Configurable
@EnableScheduling
@Component("gantry1120Task")
public class Gantry1120Task {
//    @Autowired
//    private IGantry1120Service gantryService;
//    @Autowired
//    private IChargeService chargeService;
//
//    private List<String> gantryId = Arrays.asList("G006031001001120010");
//
...
//            //log.info("更新门架gantry1120未上传牌识信息：" + gantryTravelImages);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry1120未上传牌识信息错误：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("更新门架gantry1120未上传流水信息：" + gantryTransactions);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry1120未上传流水信息错误：" + e.getMessage());
//        }
//    }
//
...
//            //log.info(" 获取门架gantry1120基础信息：" + list);
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry1120RSU基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120RSU基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry1120Vprl基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120Vprl基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry1120状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/1 * * * ?")
...
//            //log.info(" 获取门架gantry1120rsu状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120rsu状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry1120vplr状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry1120vplr状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry1120Transaction数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry1120Transaction数据报错："+e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry1120TravelImage数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry1120Travelimage数据报错："+e.getMessage());
//        }
//    }
}
