...
import com.pingok.gantry.service.gantry110.IGantry610Service;
...
@Configurable
@EnableScheduling
@Component("gantry610Task")
public class Gantry610Task {
    @Autowired
    private IGantry610Service gantryService;
    @Autowired
    private IChargeService chargeService;

    private List<String> gantryId = Arrays.asList("G006031001000610010");
...
//            //log.info("更新门架gantry610未上传牌识信息：" + gantryTravelImages);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry610未上传牌识信息错误：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("更新门架gantry610未上传流水信息：" + gantryTransactions);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry610未上传流水信息错误：" + e.getMessage());
//        }
//    }
    ...
    public void gantryBaseInfo() {
        ...
        try {
            ...
            //log.info(" 获取门架gantry610基础信息：" + list);
            if (list != null && list.size() > 0) {
                ...
                for (DfsGantryBaseinfo g : list) {
                    ...
                    tblGantryBaseinfo.setGantryBaseId(g.getGantryBaseId());
                    tblGantryBaseinfo.setComputerOrder(g.getComputerOrder());
                    gantryBaseInfos.add(tblGantryBaseinfo);
                }
                chargeService.saveAllGantryBaseinfo(gantryBaseInfos);
            }
        } catch (Exception e) {
            log.error(" 获取门架gantry610基础信息报错：" + e.getMessage());
        }
    }
...
//            //log.info(" 获取门架gantry610RSU基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry610RSU基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry610Vprl基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry610Vprl基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry610状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry610状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/1 * * * ?")
...
//            //log.info(" 获取门架gantry610rsu状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry610rsu状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry610vplr状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry610vplr状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry610Transaction数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry610Transaction数据报错："+e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry610TravelImage数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry610Travelimage数据报错："+e.getMessage());
//        }
//    }
}
