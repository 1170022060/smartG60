...
import com.pingok.gantry.service.gantry110.IGantry620Service;
...
@Configurable
@EnableScheduling
@Component("gantry620Task")
public class Gantry620Task {
//    @Autowired
//    private IGantry620Service gantryService;
//    @Autowired
//    private IChargeService chargeService;
//
//    private List<String> gantryId = Arrays.asList("G006031001000620010");
//
...
//            //log.info("更新门架gantry620未上传牌识信息：" + gantryTravelImages);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry620未上传牌识信息错误：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("更新门架gantry620未上传流水信息：" + gantryTransactions);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry620未上传流水信息错误：" + e.getMessage());
//        }
//    }
//
...
//            //log.info(" 获取门架gantry620基础信息：" + list);
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry620RSU基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620RSU基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry620Vprl基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620Vprl基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry620状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/1 * * * ?")
...
//            //log.info(" 获取门架gantry620rsu状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620rsu状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry620vplr状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry620vplr状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry620Transaction数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry620Transaction数据报错："+e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry620TravelImage数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry620Travelimage数据报错："+e.getMessage());
//        }
//    }
}
