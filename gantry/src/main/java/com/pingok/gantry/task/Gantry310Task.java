...
@Configurable
//@EnableScheduling
@Component("gantry310Task")
public class Gantry310Task {
//    @Autowired
//    private IGantry310Service gantryService;
//    @Autowired
//    private IChargeService chargeService;
//
//    private List<String> gantryId = Arrays.asList("G006031001000310010");
//
...
//            //log.info("更新门架gantry310未上传牌识信息：" + gantryTravelImages);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry310未上传牌识信息错误：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("更新门架gantry310未上传流水信息：" + gantryTransactions);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry310未上传流水信息错误：" + e.getMessage());
//        }
//    }
//
...
//            //log.info(" 获取门架gantry310基础信息：" + list);
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry310RSU基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310RSU基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry310Vprl基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310Vprl基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry310状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/1 * * * ?")
...
//            //log.info(" 获取门架gantry310rsu状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310rsu状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry310vplr状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry310vplr状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry310Transaction数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry310Transaction数据报错："+e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry310TravelImage数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry310Travelimage数据报错："+e.getMessage());
//        }
//    }
}
