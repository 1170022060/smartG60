...
import com.pingok.gantry.service.gantry110.IGantry920Service;
...
@Configurable
@EnableScheduling
@Component("gantry920Task")
public class Gantry920Task {
//    @Autowired
//    private IGantry920Service gantryService;
//    @Autowired
//    private IChargeService chargeService;
//
//    private List<String> gantryId = Arrays.asList("G006031001000920010");
//
...
//            //log.info("更新门架gantry920未上传牌识信息：" + gantryTravelImages);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry920未上传牌识信息错误：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("更新门架gantry920未上传流水信息：" + gantryTransactions);
...
//            }
//        } catch (Exception e) {
//            log.error("更新门架gantry920未上传流水信息错误：" + e.getMessage());
//        }
//    }
//
...
//            //log.info(" 获取门架gantry920基础信息：" + list);
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry920RSU基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920RSU基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0 1 * * ?")
...
//            //log.info(" 获取门架gantry920Vprl基础信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920Vprl基础信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry920状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/1 * * * ?")
...
//            //log.info(" 获取门架gantry920rsu状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920rsu状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info(" 获取门架gantry920vplr状态信息：" + list);
//            if (list != null && list.size() > 0) {
...
//            }
//        } catch (Exception e) {
//            log.error(" 获取门架gantry920vplr状态信息报错：" + e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry920Transaction数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry920Transaction数据报错："+e.getMessage());
//        }
//    }
//
//    @Scheduled(cron = "0 0/5 * * * ?")
...
//            //log.info("获取门架gantry920TravelImage数据："+list);
//            if(list!=null && list.size()>0){
...
//            }
//        } catch (Exception e) {
//            log.error("获取门架gantry920Travelimage数据报错："+e.getMessage());
//        }
//    }
}
